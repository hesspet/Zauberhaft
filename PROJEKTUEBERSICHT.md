...
│   │   ├── js/
│   │   │   ├── blog-navigation.js # Clientseitige Blog-Navigation ohne harten Dokumentwechsel
...
- **Clientseitige Blog-Navigation** — interne Blog-Links ersetzen Header/Main per History API ohne vollständigen Dokumentwechsel
